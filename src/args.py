...
def get_parser():
    ...
    parser.add_argument('--model-path', type=str, default=os.path.join(current_path, "../models/bigram"), help='model folder path')

    parser.add_argument('--output-file-path', type=str, default=os.path.join(current_path, "../data/output.txt"), help='output file path')

    parser.add_argument('--input-file-path', type=str, default=os.path.join(current_path, "../data/input.txt"), help='input file path or interactive')
    ...
    parser.add_argument('--top-k-storage', type=int, default=3, help='top k used when storage state')
    parser.add_argument('--top-k-calculate', type=int, default=3, help='top k used when calculate state')
